...
struct Comparator : StalysModule {
  ...
  void process(const ProcessArgs &args) override {
    const bool out1 = inputs[SIGNAL1_INPUT].getVoltage() >
                      inputs[VALUE1_INPUT].getNormalVoltage(10.f) *
                          params[VALUE_LEVEL1_PARAM].getValue() / 10;
    const bool out2 = inputs[SIGNAL2_INPUT].getVoltage() >
                      inputs[VALUE2_INPUT].getNormalVoltage(10.f) *
                          params[VALUE_LEVEL2_PARAM].getValue() / 10;
    const bool out3 = inputs[SIGNAL3_INPUT].getVoltage() >
                      inputs[VALUE3_INPUT].getNormalVoltage(10.f) *
                          params[VALUE_LEVEL3_PARAM].getValue() / 10;
    const bool out4 = inputs[SIGNAL4_INPUT].getVoltage() >
                      inputs[VALUE4_INPUT].getNormalVoltage(10.f) *
                          params[VALUE_LEVEL4_PARAM].getValue() / 10;
    const bool out5 = inputs[SIGNAL5_INPUT].getVoltage() >
                      inputs[VALUE5_INPUT].getNormalVoltage(10.f) *
                          params[VALUE_LEVEL5_PARAM].getValue() / 10;
    const bool out6 = inputs[SIGNAL6_INPUT].getVoltage() >
                      inputs[VALUE6_INPUT].getNormalVoltage(10.f) *
                          params[VALUE_LEVEL6_PARAM].getValue() / 10;
    const bool out7 = inputs[SIGNAL7_INPUT].getVoltage() >
                      inputs[VALUE7_INPUT].getNormalVoltage(10.f) *
                          params[VALUE_LEVEL7_PARAM].getValue() / 10;
    const bool out8 = inputs[SIGNAL8_INPUT].getVoltage() >
                      inputs[VALUE8_INPUT].getNormalVoltage(10.f) *
                          params[VALUE_LEVEL8_PARAM].getValue() / 10;
