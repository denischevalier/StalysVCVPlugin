...
struct MinWidget : StalysModuleWidget {
	...
	MinWidget(Min* module) {
		...
		addInput(createInputCentered<port>(mm2px(Vec(38.1, 10.16)), module, Min::IN3_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(7.62, 25.4)), module, Min::IN4_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(22.86, 25.4)), module, Min::IN5_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(38.1, 25.4)), module, Min::IN6_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(7.62, 40.64)), module, Min::IN7_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(22.86, 40.64)), module, Min::IN8_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(38.1, 40.64)), module, Min::IN9_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(7.62, 55.88)), module, Min::IN10_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(22.86, 55.88)), module, Min::IN11_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(38.1, 55.88)), module, Min::IN12_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(7.62, 71.12)), module, Min::IN13_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(22.86, 71.12)), module, Min::IN14_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(38.1, 71.12)), module, Min::IN15_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(7.62, 86.36)), module, Min::IN16_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(22.86, 86.36)), module, Min::IN17_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(38.1, 86.36)), module, Min::IN18_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(7.62, 101.6)), module, Min::IN19_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(22.86, 101.6)), module, Min::IN20_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(38.1, 101.6)), module, Min::IN21_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(7.922, 116.415)), module, Min::IN22_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(22.86, 116.84)), module, Min::IN23_INPUT));
		addInput(createInputCentered<port>(mm2px(Vec(38.1, 116.84)), module, Min::IN24_INPUT));

		addOutput(createOutputCentered<port>(mm2px(Vec(53.34, 10.16)), module, Min::OUT1_OUTPUT));
		addOutput(createOutputCentered<port>(mm2px(Vec(53.34, 25.4)), module, Min::OUT2_OUTPUT));
		addOutput(createOutputCentered<port>(mm2px(Vec(53.34, 40.64)), module, Min::OUT3_OUTPUT));
		addOutput(createOutputCentered<port>(mm2px(Vec(53.34, 55.88)), module, Min::OUT4_OUTPUT));
		addOutput(createOutputCentered<port>(mm2px(Vec(53.34, 71.12)), module, Min::OUT5_OUTPUT));
		addOutput(createOutputCentered<port>(mm2px(Vec(53.34, 86.36)), module, Min::OUT6_OUTPUT));
		addOutput(createOutputCentered<port>(mm2px(Vec(53.34, 101.6)), module, Min::OUT7_OUTPUT));
		addOutput(createOutputCentered<port>(mm2px(Vec(53.34, 116.84)), module, Min::OUT8_OUTPUT));
	}
};
