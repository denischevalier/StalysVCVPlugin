...
struct CtV : StalysModule {
  ...
  CtV() { config(NUM_PARAMS, NUM_INPUTS, NUM_OUTPUTS, NUM_LIGHTS); }
...
struct CtVWidget : StalysModuleWidget {
  ...
  CtVWidget(CtV *module) {
    ...
    addInput(createInputCentered<port>(mm2px(Vec(7.62, 40.64)), module,
                                       CtV::IN3_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.514, 55.88)), module,
                                       CtV::IN4_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.514, 71.12)), module,
                                       CtV::IN5_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.514, 86.36)), module,
                                       CtV::IN6_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.514, 101.6)), module,
                                       CtV::IN7_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.514, 116.84)), module,
                                       CtV::IN8_INPUT));
