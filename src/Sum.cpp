...
struct Sum : StalysModule {
  ...
  Sum() { config(NUM_PARAMS, NUM_INPUTS, NUM_OUTPUTS, NUM_LIGHTS); }

  void process(const ProcessArgs &args) override {
    const float results[8] = {inputs[IN1_INPUT].getNormalVoltage(0.f) +
