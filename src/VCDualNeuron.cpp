...
struct VCDualNeuronWidget : ModuleWidget {
	VCDualNeuronWidget(VCDualNeuron* module) {
		...
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(38.1, 25.4)), module, VCDualNeuron::A_CARRIER_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(68.58, 25.4)), module, VCDualNeuron::A_OFFSET_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(99.06, 25.4)), module, VCDualNeuron::A_SENSE_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(38.1, 40.64)), module, VCDualNeuron::B_CARRIER_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(68.58, 40.64)), module, VCDualNeuron::B_OFFSET_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(129.54, 40.64)), module, VCDualNeuron::G_CARRIER_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(160.02, 40.64)), module, VCDualNeuron::G_OFFSET_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(38.1, 55.88)), module, VCDualNeuron::C_CARRIER_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(68.58, 55.88)), module, VCDualNeuron::C_OFFSET_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(99.06, 55.88)), module, VCDualNeuron::A_RESPONSE_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(38.1, 71.12)), module, VCDualNeuron::D_CARRIER_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(68.58, 71.12)), module, VCDualNeuron::D_OFFSET_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(99.06, 71.12)), module, VCDualNeuron::B_SENSE_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(38.1, 86.36)), module, VCDualNeuron::E_CARRIER_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(68.58, 86.36)), module, VCDualNeuron::E_OFFSET_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(129.54, 86.36)), module, VCDualNeuron::H_CARRIER_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(160.02, 86.36)), module, VCDualNeuron::H_OFFSET_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(38.1, 101.6)), module, VCDualNeuron::F_CARRIER_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(68.58, 101.6)), module, VCDualNeuron::F_OFFSET_LEVEL_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(99.06, 101.6)), module, VCDualNeuron::B_RESPONSE_LEVEL_PARAM));

		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(22.86, 25.4)), module, VCDualNeuron::A_SIGNAL_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(53.34, 25.4)), module, VCDualNeuron::A_CARRIER_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(84.455, 25.4)), module, VCDualNeuron::A_OFFSET_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(114.3, 25.4)), module, VCDualNeuron::A_SENSE_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(22.86, 40.64)), module, VCDualNeuron::B_SIGNAL_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(53.34, 40.64)), module, VCDualNeuron::B_CARRIER_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(84.455, 40.64)), module, VCDualNeuron::B_OFFSET_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(114.3, 40.64)), module, VCDualNeuron::G_SIGNAL_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(144.78, 40.64)), module, VCDualNeuron::G_CARRIER_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(175.26, 40.64)), module, VCDualNeuron::G_OFFSET_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(22.86, 55.88)), module, VCDualNeuron::C_SIGNAL_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(53.34, 55.88)), module, VCDualNeuron::C_CARRIER_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(84.455, 55.88)), module, VCDualNeuron::C_OFFSET_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(114.3, 55.88)), module, VCDualNeuron::A_RESPONSE_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(22.86, 71.12)), module, VCDualNeuron::D_SIGNAL_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(53.34, 71.12)), module, VCDualNeuron::D_CARRIER_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(83.82, 71.12)), module, VCDualNeuron::D_OFFSET_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(114.3, 71.12)), module, VCDualNeuron::B_SENSE_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(22.86, 86.36)), module, VCDualNeuron::E_SIGNAL_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(53.34, 86.36)), module, VCDualNeuron::E_CARRIER_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(83.82, 86.36)), module, VCDualNeuron::E_OFFSET_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(114.3, 86.36)), module, VCDualNeuron::H_SIGNAL_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(144.78, 86.36)), module, VCDualNeuron::H_CARRIER_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(175.26, 86.36)), module, VCDualNeuron::H_OFFSET_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(22.86, 101.6)), module, VCDualNeuron::F_SIGNAL_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(53.34, 101.6)), module, VCDualNeuron::F_CARRIER_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(83.82, 101.6)), module, VCDualNeuron::F_OFFSET_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(114.3, 101.6)), module, VCDualNeuron::B_RESPONSE_INPUT));

		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(190.5, 25.4)), module, VCDualNeuron::DIFFRECT_POS_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(99.06, 40.64)), module, VCDualNeuron::A_OUTPUT_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(190.5, 40.64)), module, VCDualNeuron::MAX_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(190.5, 55.88)), module, VCDualNeuron::SUM_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(190.5, 71.12)), module, VCDualNeuron::INV_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(99.06, 86.36)), module, VCDualNeuron::B_OUTPUT_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(190.5, 86.36)), module, VCDualNeuron::MIN_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(190.5, 101.6)), module, VCDualNeuron::DIFFRECT_NEG_OUTPUT));
	}
};
