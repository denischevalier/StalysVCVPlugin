...
struct PosNegRectifier : StalysModule {
  ...
  PosNegRectifier() { config(NUM_PARAMS, NUM_INPUTS, NUM_OUTPUTS, NUM_LIGHTS); }
...
struct PosNegRectifierWidget : StalysModuleWidget {
  ...
  PosNegRectifierWidget(PosNegRectifier *module) {
    ...
    addInput(createInputCentered<port>(mm2px(Vec(7.62, 10.16)), module,
                                       PosNegRectifier::SIGNAL1_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.62, 25.4)), module,
                                       PosNegRectifier::SIGNAL2_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.62, 40.64)), module,
                                       PosNegRectifier::SIGNAL3_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.62, 55.88)), module,
                                       PosNegRectifier::SIGNAL4_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.62, 71.12)), module,
                                       PosNegRectifier::SIGNAL5_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.62, 86.36)), module,
                                       PosNegRectifier::SIGNAL6_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.62, 101.6)), module,
                                       PosNegRectifier::SIGNAL7_INPUT));
    addInput(createInputCentered<port>(mm2px(Vec(7.62, 116.84)), module,
                                       PosNegRectifier::SIGNAL8_INPUT));

    addOutput(createOutputCentered<port>(mm2px(Vec(22.86, 10.16)), module,
                                         PosNegRectifier::POS1_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(38.1, 10.16)), module,
                                         PosNegRectifier::NEG1_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(22.86, 25.4)), module,
                                         PosNegRectifier::POS2_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(38.1, 25.4)), module,
                                         PosNegRectifier::NEG2_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(22.86, 40.64)), module,
                                         PosNegRectifier::POS3_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(38.1, 40.64)), module,
                                         PosNegRectifier::NEG3_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(22.86, 55.88)), module,
                                         PosNegRectifier::POS4_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(38.1, 55.88)), module,
                                         PosNegRectifier::NEG4_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(22.86, 71.12)), module,
                                         PosNegRectifier::POS5_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(38.1, 71.12)), module,
                                         PosNegRectifier::NEG5_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(22.86, 86.36)), module,
                                         PosNegRectifier::POS6_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(38.1, 86.36)), module,
                                         PosNegRectifier::NEG6_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(22.86, 101.6)), module,
                                         PosNegRectifier::POS7_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(38.1, 101.6)), module,
                                         PosNegRectifier::NEG7_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(22.86, 116.84)), module,
                                         PosNegRectifier::POS8_OUTPUT));
    addOutput(createOutputCentered<port>(mm2px(Vec(38.1, 116.84)), module,
